...
//         <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-500 to-pink-500 flex items-center justify-center text-white shrink-0">
...
//                   ${
//                     m.role === "user"
//                       ? "bg-gradient-to-br from-blue-500 to-pink-500 text-white rounded-br-sm"
